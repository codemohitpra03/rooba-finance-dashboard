  ...
  return (
    <div className='grid grid-rows-[100px_100px]'>
		<div className="flex items-center justify-around lg:justify-between lg:px-[50px] lg:py-[30px] border-l-[1px] border-b-[1px]">
			<div id='openmenu' className='inline-block p-0 cursor-pointer lg:hidden' onClick={()=>{
				document.getElementById('navbar').classList.add("translate-x-[100vw]");
			...
			<div id="closemenu" className='hidden w-[24px]  md:h-[57px] md:w-[32px] p-3 border-black  lg:hidden' onClick={()=>{
						document.getElementById('navbar').classList.remove("translate-x-[100vw]");
			...
			<div>
				<button className='bg-buttonbg h-10 w-36 md:h-[52px] md:w-[166px] text-buttontext'>Complete Profile</button>
			</div>
			<div>
